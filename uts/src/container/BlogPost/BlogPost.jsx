            ...
            <div className="post-artikel">
                ...
                <h2>Daftar Produk</h2>
                {
                    this.state.listProduk.map(artikel => {
                        return <Post key={artikel.idProduk} id={artikel.id} namaproduk={artikel.namaproduk} harga={artikel.harga} gambar={artikel.gambar} stock={artikel.stock} idArtikel={artikel.id} tambahArtikel={this.handleTombolSimpan}/>
                    })
